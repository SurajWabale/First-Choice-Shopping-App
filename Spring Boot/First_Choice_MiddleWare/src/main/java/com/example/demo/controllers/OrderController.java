...
//		Login l=lservice.getLoginById(or.getCust_id());
		Customer co1=cservice.getCustomer(or.getC_id());
		//Customer co=cservice.getCustomer(or.getCust_id());
		
			LocalDate date = LocalDate.now();
			Date d = Date.valueOf(date);
		Order order1=new Order(co1, d, or.getTotal_amount(), or.getShipping_address());
		Order o=oservice.saveOrder(order1);
		return o;
	}
